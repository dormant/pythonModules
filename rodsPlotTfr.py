...
def plot_tfr(st, dt=0.01, t0=0., fmin=1., fmax=10., nf=100, w0=6, left=0.1,
             ...
             cmap=obspy_sequential, mode='amp', fft_zero_pad_fac=0):
    """
    ...
    :param cmap: colormap for TFEM/TFPM, either a string or
        matplotlib.cm.Colormap instance
##### RCS addition
    :param mode: 'absolute' for absolute value of TFR, 'power' for ``|TFR|^2``,'sqrt' for square root
...
##### RCS addition
        ax_sig.plot(t, st[itr], plot_args[0], linewidth=0.2)
        ax_sig.grid(axis = 'x')
        ...
        ax_spec.semilogy(spec[itr], f_lin, plot_args[1], linewidth=0.2)
        ax_spec.grid(axis = 'y')
